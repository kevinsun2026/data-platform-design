"""Error-translation glue for the Audit API.

The audit service uses :class:`aidp_common.errors.AppError` for every
...
This is the same pattern :mod:`aidp_iam.api.errors` ships — kept
verbatim so the platform's error contract stays uniform across
services.
"""
